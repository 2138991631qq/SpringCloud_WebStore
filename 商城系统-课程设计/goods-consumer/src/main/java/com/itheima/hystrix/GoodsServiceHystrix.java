...
public class GoodsServiceHystrix implements GoodsService {
    ...
    @Override
    public int insertGoods(String gname, String gremain, String gdetails, int gprice, int types) {
        return 0;
    }

    @Override
    public int updateGoods(String gname, String gremain, String gdetails, int gprice, int types,int gid) {
        return 0;
    }
